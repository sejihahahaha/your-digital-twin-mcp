...
export default function Home() {
  return (
    <div className="w-full bg-black text-white overflow-hidden relative">
      ...
      <div className="fixed inset-0 grid-texture pointer-events-none" />
      ...
      <div className="fixed top-0 left-1/4 w-[800px] h-[800px] radial-glow pointer-events-none" />
      <div className="fixed bottom-0 right-1/4 w-[600px] h-[600px] radial-glow pointer-events-none" />
          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col gap-6">
              <div className="space-y-2">
                <h1 className="text-6xl md:text-7xl font-bold text-white">Krystel Lingat</h1>
                <p className="text-2xl text-red-400">AI & Database Specialist</p>
              </div>
              <p className="text-lg text-gray-300 leading-relaxed">
                BS Information Technology Major in AI | Database Certified | Building intelligent systems that
                understand the world
              </p>
              <div className="flex gap-4 pt-4">
                <Link href="/chat">
                  <Button className="bg-red-600 hover:bg-red-700 text-white px-8">Chat with My Digital Twin</Button>
                </Link>
                <Link href="/about">
                  <Button
                    variant="outline"
                    className="border-red-600 text-red-400 hover:bg-red-600/10 px-8 bg-transparent"
                  >
                    Learn More
                  </Button>
                </Link>
        ...
        <section className="py-20 px-6 border-t border-red-900/30">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-8">
              Explore my work, skills, and chat with my intelligent digital twin powered by advanced AI
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-8 rounded-xl border border-red-900/30 hover:border-red-600/50 transition-all hover:bg-red-900/10">
                ...
                <p className="text-gray-400">
                  End-to-end development with Python, Laravel, and modern web technologies
                </p>
              </div>
              <div className="p-8 rounded-xl border border-red-900/30 hover:border-red-600/50 transition-all hover:bg-red-900/10">
